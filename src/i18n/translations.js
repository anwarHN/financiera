export const translations = {
  es: {
    ...
    sidebar: {
      ...
      core: "General",
      sales: "Ventas",
      otherTransactions: "Otros ingresos / gastos",
      concepts: "Conceptos",
    ...
    actions: {
      ...
      newSale: "Nueva factura",
      newAccountReceivable: "Nueva cuenta por cobrar",
      newAccountPayable: "Nueva cuenta por pagar",
      newPurchase: "Nueva compra de mercadería",
      newInventoryAdjustment: "Nuevo ajuste de inventario de mercadería",
      newExpense: "Nuevo otro gasto",
      newIncome: "Nuevo otro ingreso",
    ...
    auth: {
      ...
      welcomeTitle: "Controla tu operación y tus finanzas en un solo lugar",
      welcomeText: "Organiza ventas, cuentas por cobrar, pagos, inventario y reportes con una experiencia clara y enfocada en el trabajo diario.",
      registerWelcomeTitle: "Crea tu cuenta y configura tu operación desde el primer día",
      registerWelcomeText: "Empieza con una estructura lista para ventas, cobros, pagos, inventario y reportes, sin depender de procesos manuales dispersos.",
    ...
    nav: {
      ...
      priorBalanceSale: "Nueva factura para saldo anterior",
    ...
    reports: {
      ...
      budgetCurrencyRequired: "Configura la moneda del presupuesto antes de consultar su ejecución.",
      budgetCurrencyMismatch: "La moneda seleccionada debe coincidir con la del presupuesto.",
      cashboxRequired: "Selecciona una caja.",
      selectCashbox: "Seleccionar caja",
      executed: "Ejecutado",
      variance: "Variación",
      ...
      employeePayroll: "Planilla de empleados",
      cashboxesBalance: "Saldos de cajas",
      cashboxMovements: "Movimientos de caja chica",
      pendingDeliveries: "Pendientes de entrega",
      payrollAdjustment: "Ajuste del período",
      payrollTotal: "Total planilla",
    ...
    budgets: {
      ...
      income: "Ingreso",
      expense: "Gasto",
      incomeConcept: "Concepto de ingreso para presupuestos",
      unclassified: "Sin clasificar",
      unbudgeted: "No presupuestado",
      result: "Resultado (ingresos menos gastos)",
      basis: "Ingresos facturados sin impuestos, después de descuentos; gastos por su importe registrado. No representa flujo de caja ni utilidad contable completa.",
      unclassifiedWarning: "Hay ingresos sin concepto asignado. Se incluyen en el resultado, pero requieren revisión de su clasificación.",
      returnWarning: "Hay devoluciones históricas sin valoración monetaria. El resultado no descuenta esas devoluciones y requiere revisión.",
      duplicateLine: "No se puede repetir un concepto para el mismo tipo de línea.",
      periodType: "Período",
    ...
    transactions: {
      salesTitle: "Registro de facturas",
      accountsReceivableTitle: "Registro de cuentas por cobrar",
      accountsPayableTitle: "Registro de cuentas por pagar",
      purchasesTitle: "Registro de compras de mercadería",
      inventoryAdjustmentsTitle: "Registro de ajustes de inventario de mercadería",
      expensesTitle: "Registro de otros gastos",
      incomesTitle: "Registro de otros ingresos",
      outgoingPaymentsTitle: "Registro de pagos salientes",
      incomingPaymentsTitle: "Registro de pagos entrantes",
      salesCreateTitle: "Crear factura",
      receivableCreateTitle: "Crear cuenta por cobrar",
      payableCreateTitle: "Crear cuenta por pagar",
      purchasesCreateTitle: "Crear compra de mercadería",
      inventoryAdjustmentsCreateTitle: "Crear ajuste de inventario de mercadería",
      newPriorBalanceSale: "Nueva factura para saldo anterior",
      newPriorBalancePurchase: "Nueva compra para saldo anterior",
      newManualReceivable: "Nueva cuenta por cobrar",
      newManualPayable: "Nueva cuenta por pagar",
      ...
      manualReceivableDescription: "Cuenta por cobrar",
      manualPayableDescription: "Cuenta por pagar",
      ...
      incomesCreateTitle: "Crear otro ingreso",
      ...
      affectsPayroll: "Afecta planilla de empleado",
      affectsPayrollHelp: "Activa esta opción para que este ingreso o gasto ajuste la planilla del empleado seleccionado en el reporte de planilla.",
      ...
      printInvoiceTxt: "Imprimir factura",
      printInvoiceTxtLoading: "Generando impresión...",
      ...
      paymentsDetailTitle: "Detalle de pagos",
      ...
      missingSystemPaymentConcept: "No existe el concepto de sistema requerido para esta operación.",
      seller: "Vendedor",
      ...
      tags: "Etiquetas",
      tagsPlaceholder: "Escribe y presiona Enter para agregar etiqueta",
  ...
  en: {
    ...
    sidebar: {
      ...
      core: "Core",
      sales: "Sales",
      otherTransactions: "Other income / expenses",
      concepts: "Concepts",
    ...
    actions: {
      ...
      newSale: "New invoice",
      newAccountReceivable: "New accounts receivable entry",
      newAccountPayable: "New accounts payable entry",
      newPurchase: "New merchandise purchase",
      newInventoryAdjustment: "New merchandise inventory adjustment",
      newExpense: "New other expense",
      newIncome: "New other income",
    ...
    auth: {
      ...
      welcomeTitle: "Run your operation and finances in one place",
      welcomeText: "Manage sales, receivables, payments, inventory and reporting with a clear workflow built for daily operations.",
      registerWelcomeTitle: "Create your account and set up your operation from day one",
      registerWelcomeText: "Start with a structure ready for sales, collections, payments, inventory and reporting without relying on scattered manual processes.",
    ...
    nav: {
      ...
      priorBalanceSale: "New invoice for prior balance",
    ...
    reports: {
      ...
      budgetCurrencyRequired: "Configure the budget currency before viewing execution.",
      budgetCurrencyMismatch: "The selected currency must match the budget currency.",
      cashboxRequired: "Select a cashbox.",
      ...
      cashboxMovements: "Petty cash movements",
      pendingDeliveries: "Pending deliveries",
      payrollAdjustment: "Period adjustment",
    ...
    budgets: {
      ...
      income: "Income",
      expense: "Expense",
      incomeConcept: "Income concept for budgets",
      unclassified: "Unclassified",
      unbudgeted: "Unbudgeted",
      result: "Result (income minus expenses)",
      basis: "Invoiced income excluding taxes, after discounts; expenses at their recorded amount. Not cash flow or full accounting profit.",
      unclassifiedWarning: "Some income has no assigned concept. It is included in the result but requires classification review.",
      returnWarning: "Historical returns without a monetary valuation exist. The result does not deduct those returns and requires review.",
      duplicateLine: "A concept cannot be repeated for the same line type.",
      periodType: "Period",
      lines: "Budget lines",
      addLine: "Add line",
    ...
    transactions: {
      salesTitle: "Invoice entries",
      accountsReceivableTitle: "Accounts receivable entries",
      accountsPayableTitle: "Accounts payable entries",
      purchasesTitle: "Merchandise purchase entries",
      inventoryAdjustmentsTitle: "Merchandise inventory adjustment entries",
      expensesTitle: "Other expense entries",
      incomesTitle: "Other income entries",
      outgoingPaymentsTitle: "Outgoing payments",
      incomingPaymentsTitle: "Incoming payments",
      salesCreateTitle: "Create invoice",
      receivableCreateTitle: "Create accounts receivable entry",
      payableCreateTitle: "Create accounts payable entry",
      purchasesCreateTitle: "Create merchandise purchase",
      inventoryAdjustmentsCreateTitle: "Create merchandise inventory adjustment",
      newPriorBalanceSale: "New invoice for prior balance",
      newPriorBalancePurchase: "New purchase for prior balance",
      newManualReceivable: "New accounts receivable entry",
      newManualPayable: "New accounts payable entry",
      ...
      manualReceivableDescription: "Accounts receivable entry",
      manualPayableDescription: "Accounts payable entry",
      ...
      incomesCreateTitle: "Create other income",
      ...
      affectsPayroll: "Affects employee payroll",
      affectsPayrollHelp: "Enable this option so this income or expense adjusts the selected employee payroll in the payroll report.",
      ...
      printInvoiceTxt: "Print invoice",
      printInvoiceTxtLoading: "Preparing print...",
      ...
      paymentsDetailTitle: "Payments detail",
      noPaymentsApplied: "No applied payments.",
      ...
      missingSystemPaymentConcept: "Missing required system concept for this operation.",
      seller: "Seller",
