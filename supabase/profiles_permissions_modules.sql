...
set permissions = coalesce(permissions, '{}'::jsonb)
  || jsonb_build_object(
    ...
    'reportAccess', coalesce(permissions->'reportAccess', '{}'::jsonb) || '{"sales":true,"receivable":true,"payable":true,"internal_obligations":true,"budget_execution":true,"project_execution":true,"expenses":true,"cashflow":true,"employee_absences":true,"sales_by_employee":true,"expenses_by_tag_payment_form":true,"employee_loans":true,"employee_payroll":true,"cashboxes_balance":true,"pending_deliveries":true}'::jsonb
  );
