...
set permissions = coalesce(permissions, '{}'::jsonb)
  || jsonb_build_object(
    ...
    'reportAccess', coalesce(permissions->'reportAccess', '{"sales":true,"receivable":true,"payable":true,"internal_obligations":true,"budget_execution":true,"project_execution":true,"expenses":true,"cashflow":true,"employee_absences":true,"sales_by_employee":true}'::jsonb)
  );
